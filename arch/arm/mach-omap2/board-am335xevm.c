...
#define CYTTSP6_USE_I2C
/* #define CYTTSP6_USE_SPI */

#ifdef CYTTSP6_USE_I2C
#define CYTTSP6_I2C_TCH_ADR 0x24
#define CYTTSP6_LDR_TCH_ADR 0x24
#define CYTTSP6_I2C_IRQ_GPIO GPIO_TO_PIN(3,19) /* J6.9, C19, GPMC_AD14/GPIO_38 */
#define CYTTSP6_I2C_RST_GPIO GPIO_TO_PIN(1,16) /* J6.10, D18, GPMC_AD13/GPIO_37 */
#define CYTTSP6_I2C_ERR_GPIO GPIO_TO_PIN(1,17) /* J6.10, D18, GPMC_AD13/GPIO_37 */
#endif

#ifdef CYTTSP6_USE_SPI
 ...
 */
#define CYTTSP6_SPI_IRQ_GPIO GPIO_TO_PIN(3,19) /* J6.9, C19, GPMC_AD14/GPIO_38 */
#define CYTTSP6_SPI_RST_GPIO GPIO_TO_PIN(3,21) /* J6.10, D18, GPMC_AD13/GPIO_37 */
#define CYTTSP6_SPI_ERR_GPIO GPIO_TO_PIN(1,17) /* J6.10, D18, GPMC_AD13/GPIO_37 */
#endif

/* Check GPIO numbers if both I2C and SPI are enabled */
#if defined(CYTTSP6_USE_I2C) && defined(CYTTSP6_USE_SPI)
#if CYTTSP6_I2C_IRQ_GPIO == CYTTSP6_SPI_IRQ_GPIO || \
        CYTTSP6_I2C_RST_GPIO == CYTTSP6_SPI_RST_GPIO
...
static struct touch_settings cyttsp6_sett_btn_keys = {
        .data = (uint8_t *)&cyttsp6_btn_keys[0],
        .size = ARRAY_SIZE(cyttsp6_btn_keys),
        .tag = 0,
};
...
static struct cyttsp6_core_platform_data _cyttsp6_core_platform_data = {
	...
	.max_xfer_len = CYTTSP6_I2C_MAX_XFER_LEN,
        ...
        .sett = {
                ...
                &cyttsp6_sett_btn_keys, /* button-to-keycode table */
        },
...
static ssize_t cyttsp6_virtualkeys_show(struct kobject *kobj,
...
static struct kobj_attribute cyttsp6_virtualkeys_attr = {
        .attr = {
                .name = "virtualkeys.cyttsp6_mt",
                .mode = S_IRUGO,
        },
        .show = &cyttsp6_virtualkeys_show,
};

static struct attribute *cyttsp6_properties_attrs[] = {
        &cyttsp6_virtualkeys_attr.attr,
        NULL
};

static struct attribute_group cyttsp6_properties_attr_group = {
        .attrs = cyttsp6_properties_attrs,
};
#endif /* CONFIG_TOUCHSCREEN_CYPRESS_CYTTSP6_DEVICETREE_SUPPORT */

static void __init omap4_beaglebone_cyttsp6_init(void)
{
#ifndef CONFIG_TOUCHSCREEN_CYPRESS_CYTTSP6_DEVICETREE_SUPPORT
...
#ifdef CYTTSP6_USE_I2C
        omap_mux_init_gpio(CYTTSP6_I2C_RST_GPIO, OMAP_MUX_MODE7 | AM33XX_PIN_OUTPUT);
        omap_mux_init_gpio(CYTTSP6_I2C_IRQ_GPIO, OMAP_MUX_MODE7 | AM33XX_PIN_INPUT_PULLUP);
#endif
#ifdef CYTTSP6_USE_SPI
        omap_mux_init_gpio(CYTTSP6_SPI_RST_GPIO, OMAP_PIN_OUTPUT);
        omap_mux_init_gpio(CYTTSP6_SPI_IRQ_GPIO, OMAP_PIN_INPUT_PULLUP);
#endif
}
/* end of CYPRESS TTSP */
...
static struct i2c_board_info am335x_i2c2_boardinfo[] = {
	...
	},
	{
...
#ifdef CYTTSP6_USE_I2C
        {
                ...
                .irq =  OMAP_GPIO_IRQ(CYTTSP6_I2C_IRQ_GPIO),
